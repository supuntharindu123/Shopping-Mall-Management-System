          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 border-t border-gray-100 pt-8">
                <button
                  onClick={() => navigate(`/admin/shop/${id}/add-item`)}
                  className="px-6 py-2 bg-teal-600 text-white rounded-xl hover:bg-teal-700 transition duration-200"
                >
                  Add Item
                </button>
                <button
                  onClick={() => navigate(`/admin/shop/${id}/edit`)}
                ...
                <button
                  ...
                  className="px-6 py-2 bg-red-600 text-white rounded-xl hover:bg-red-700 transition duration-200"
                >
                  Delete Shop
                </button>
              </div>
